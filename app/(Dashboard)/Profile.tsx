...
import darkmode from "../../assets/images/profilepage/theme.png";
...
import Edit1 from "../../assets/images/profilepage/Edit.png";
      ...
      <View style={styles.profileContainer}>
        <View style={styles.card}>
          ...
          <View style={styles.textContainer}>
            <Text style={styles.name}>Izaz Ahmad</Text>
            <Text style={styles.email}>{"Izazahmadhaider0@gmail.com"}</Text>
          </View>
          <TouchableOpacity>
