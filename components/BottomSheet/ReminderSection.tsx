...
import DeleteConfirmationModal from "@/components/BottomSheet/DeleteConfirmationModal"; // ✅ Import
...
const ReminderSection = () => {
  ...
  const [isDeleteModalVisible, setIsDeleteModalVisible] = useState(false); // ✅ New
  ...
  const askDeleteReminder = (index: number) => {
      ...
      {reminders.map((reminder, index) => (
        <View key={index} style={styles.reminderFieldRow}>
          ...
          <View style={styles.rightIcons}>
            <TouchableOpacity
              onPress={() => askDeleteReminder(index)} // ✅ Updated
      ...
      <DeleteConfirmationModal
        ...
        onConfirm={() => {
          if (selectedDeleteIndex !== null) {
            handleDeleteReminder(selectedDeleteIndex);
          }
          setIsDeleteModalVisible(false);
          setSelectedDeleteIndex(null);
        }}
