...
const StackNavigation = () =>{
    return <Stack.Navigator initialRouteName={SCREENS.intro}>
        ...
        <Stack.Screen name={SCREENS.ForgotPassword} component={ForgotPassword} options={{headerShown:false}}/>
        <Stack.Screen name={SCREENS.EmailSuccess} component={EmailSuccess} options={{headerShown:false}}/>
        <Stack.Screen name={SCREENS.ResetPassword} component={ResetPassword} options={{headerShown:false}}/>
        <Stack.Screen name={SCREENS.Congratulation} component={Congratulation} options={{headerShown:false}}/>
        <Stack.Screen name={SCREENS.Dashbored} component={DashboredIndex} options={{headerShown:false}}/>
